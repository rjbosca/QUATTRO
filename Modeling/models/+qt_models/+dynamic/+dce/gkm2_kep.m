classdef gkm2_kep < gkm
    ...
    properties (Constant)
        ...
        modelName = '2 Param. General Kinetic Model (kep)';
    ...
    methods
        ...
        function obj = gkm2_kep(varargin)
        %gkm2_kep  Class for modeling DCE-MRI data with the 2 parameter GKM
        %
        %   OBJ = gkm2_kep(T,Y,VIF) creates a GKM3_VE modeling object for the
        ...
        %
        %   OBJ = gkm2_kep(QTEXAM) creates a QUATTRO-linked GKM3_VE modeling
        %   object. This provides automatic updates to the object properties
        %   when changes to the qt_exam object QTEXAM occur.
        %
        %   OBJ = gkm2_kep(...,'PROP1',VAL1,...) creates the modeling object as
    ...
    methods
        ...
        function val = get.modelFcn(obj)
            ...
            val = @(x,xData) gkm_kep([x(:);0],xData,v,hct);

        end %gkm2_kep.get.modelFcn
