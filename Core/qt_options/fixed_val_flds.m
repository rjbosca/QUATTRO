...
flds = {'multiteModel','multitrModel','multiflipModel',...%model options
        'multitiModel','dwModel','edwiModel','dceModel',...%model options
        'dscModel',...%model options
        'multiSlice',...%multi slice option
        's0Map','r1Map','t1Map','r2Map','t2Map',...%relaxometry maps
        'flipAngleMap','invertIr',...%relaxometry maps
