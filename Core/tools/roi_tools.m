...
%   stats tools, and the storage display (listbox)
    ...
    addlistener(hList,'Value',  'PreSet' ,@listbox_value_preset);    %listbox_rois
    addlistener(hList,'Value',  'PostSet',@listbox_value_postset);   %listbox_rois
